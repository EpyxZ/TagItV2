...
#ifndef BITCOIN_WALLOGET_H
#define BITCOIN_WALLOGET_H
...
enum WalletFeature
{
    ...
    FEATURE_WALLOGETCRYPT = 40000, // wallet encryption
    FEATURE_COMPRPUBKEY = 60000, // compressed public keys
    FEATURE_MALLOGKEY = 60018,
...
public:
    ...
    */
    ...
    bool LoadCryptedKey(const CPubKey &vchPubKey, const std::vector<unsigned char> &vchCryptedSecret) { SetMinVersion(FEATURE_WALLOGETCRYPT); return CCryptoKeyStore::AddCryptedKey(vchPubKey, vchCryptedSecret); }
