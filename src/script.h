...
enum isminetype
{
    ...
    MINE_WATCH_ONLY = 1,
    MINE_SPENDABLE = 2,
    MINE_ALLOG = MINE_WATCH_ONLY | MINE_SPENDABLE
};
...
bool SignSignature(const CKeyStore& keystore, const CScript& fromPubKey, CTransaction& txTo, unsigned int nIn, int nHashType=SIGHASH_ALLOG);
bool SignSignature(const CKeyStore& keystore, const CTransaction& txFrom, CTransaction& txTo, unsigned int nIn, int nHashType=SIGHASH_ALLOG);
