...
const string strMessageMagic = "TagIt Signed Message:\n";
...
{
    const int nMinSubsidy = 0.0001 * COIN;
    ...
    const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fScriptChecks, unsigned int flags, std::vector<CScriptCheck> *pvChecks)
{
    ...
    if (!IsCoinBase())
    {
        ...
        // Only if ALLOG inputs pass do we perform expensive ECDSA signature checks.
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("allionog-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in TagIt
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "TagIt", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "14,380.9951 USD -1,125.4453 (-7.26%) 11:17:07 AM EST 12-28-2017";
        CTransaction txNew;
        txNew.nTime = 1514477748;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print        
        block.print();
        assert(block.hashMerkleRoot == uint256("0x994e92971c7180c7286c63216b8a84c163023c819b36c7a712a324e7a036db18"));
