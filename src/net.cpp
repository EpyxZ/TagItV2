...
static const char *strDNSSeed[][2] = {
    {"node1.allion.us", "node1.allion.us"},
    {"node2.allion.us", "node2.allion.us"},
    {"node3.allion.us", "node3.allion.us"},
    {"node4.allion.us", "node4.allion.us"},
    {"node5.allion.us", "node5.allion.us"},
    {"node6.allion.us", "node6.allion.us"},
    {"node7.allion.us", "node7.allion.us"},
    {"node8.allion.us", "node8.allion.us"},
    {"node9.allion.us", "node9.allion.us"},
    {"node10.allion.us", "node10.allion.us"}
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("allionog-dnsseed");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. TagIt is probably already running."), addrBind.ToString().c_str());
        else
