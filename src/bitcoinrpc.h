...
enum RPCErrorCode
{
    ...
    // Wallet errors
    RPC_WALLOGET_ERROR                = -4,  // Unspecified problem with wallet (key not found etc.)
    RPC_WALLOGET_INSUFFICIENT_FUNDS   = -6,  // Not enough funds in wallet or account
    RPC_WALLOGET_INVALID_ACCOUNT_NAME = -11, // Invalid account name
    RPC_WALLOGET_KEYPOOL_RAN_OUT      = -12, // Keypool ran out, call keypoolrefill first
    RPC_WALLOGET_UNLOCK_NEEDED        = -13, // Enter the wallet passphrase with walletpassphrase first
    RPC_WALLOGET_PASSPHRASE_INCORRECT = -14, // The wallet passphrase entered was incorrect
    RPC_WALLOGET_WRONG_ENC_STATE      = -15, // Command given in wrong wallet encryption state (encrypting an encrypted wallet etc.)
    RPC_WALLOGET_ENCRYPTION_FAILED    = -16, // Failed to encrypt the wallet
    RPC_WALLOGET_ALREADY_UNLOCKED     = -17  // Wallet is already unlocked
};
