...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("IT");
    case mBTC: return QString("mIT");
    case uBTC: return QString::fromUtf8("μIT");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("TagIts"));
    case mBTC: return QString(QObject::tr("Milli-TagIts (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-TagIts (1 / 1,000,000)"));
    default: return QString("???");
    }
}
