...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("strThirdPartyTxUrls")) {
        if(fTestNet)
            ...
            settings.setValue("strThirdPartyTxUrls", "http://ALLOG.allion.us/explorer/?%s|http://ALLOG.allion.us/explorer/?%s|http://ALLOG.allion.us/explorer/?%s");
    }
    strThirdPartyTxUrls = settings.value("strThirdPartyTxUrls", "http://ALLOG.allion.us/explorer/?%s|http://ALLOG.allion.us/explorer/?%s|http://ALLOG.allion.us/explorer/?%s").toString();
